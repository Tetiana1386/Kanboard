...
public class EnvProperties {
    ...
    public static final String DB_USER_NAME = propertyValue(PATH_TO_RESOURCE, PROPERTIES_FILE_NAME, "db_user");
    public static final String DB_PASSWORD = propertyValue(PATH_TO_RESOURCE, PROPERTIES_FILE_NAME, "db_password");
